...
const NewVehicleModal = ({ open, onOpenChange, clientId }: NewVehicleModalProps) => {
  const { addVehicle, clients } = useApp();
  ...
  const [formData, setFormData] = useState({
    ...
    plate: '',
    plateFormat: 'ABC-1234' as 'ABC-1234' | 'ABC1D23',
    clientId: clientId || ''
  });

  // Atualiza o clientId do formulário quando ele mudar nas props
  useEffect(() => {
    if (open && clientId) {
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(value: 'ABC-1234' | 'ABC1D23') => {
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="ABC1D23">ABC1D23 (Mercosul)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder={formData.plateFormat === 'ABC-1234' ? 'ABC-1234' : 'ABC1D23'}
